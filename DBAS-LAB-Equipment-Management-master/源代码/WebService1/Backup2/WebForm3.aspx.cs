...
namespace WebService1
{
	...
	public class WebForm3 : System.Web.UI.Page
	{
		...
		private void Button1_Click(object sender, System.EventArgs e)
		{
			...
			sql1="select * from basicinfo where 设备id in (select 设备id from info group by 设备id having count(*)<2) and 设备名称id="+sb+" and 厂家id="+cj;
			db1.cleardata();
			...
			for(i = 0+10*Int32.Parse(this.Hidden1.Value),l=0; i < db1.getdata().Tables["basicinfo"].Rows.Count&&l<10; i++,l++)
			{
				...
				DateTime t=DateTime.Parse(db1.getdata().Tables["info"].Rows[0]["登记日期"].ToString());

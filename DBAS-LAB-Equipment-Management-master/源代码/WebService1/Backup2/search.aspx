<%@ Page language="c#" Codebehind="search.aspx.cs" AutoEventWireup="false" Inherits="WebService1.search" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:DropDownList id="DropDownList2" style="Z-INDEX: 101; LEFT: 80px; POSITION: absolute; TOP: 24px"
				runat="server"></asp:DropDownList>
			<asp:DropDownList id="DropDownList7" style="Z-INDEX: 118; LEFT: 360px; POSITION: absolute; TOP: 96px"
				runat="server"></asp:DropDownList>
			<asp:DropDownList id="DropDownList6" style="Z-INDEX: 117; LEFT: 232px; POSITION: absolute; TOP: 88px"
				runat="server"></asp:DropDownList>
			<asp:DropDownList id="DropDownList5" style="Z-INDEX: 116; LEFT: 128px; POSITION: absolute; TOP: 88px"
				runat="server"></asp:DropDownList>
			<asp:DropDownList id="DropDownList4" style="Z-INDEX: 115; LEFT: 360px; POSITION: absolute; TOP: 64px"
				runat="server"></asp:DropDownList>
			<asp:DropDownList id="DropDownList3" style="Z-INDEX: 114; LEFT: 232px; POSITION: absolute; TOP: 56px"
				runat="server"></asp:DropDownList>
			<asp:Label id="Label18" style="Z-INDEX: 107; LEFT: 200px; POSITION: absolute; TOP: 64px" runat="server">年</asp:Label>
			<asp:Label id="Label17" style="Z-INDEX: 109; LEFT: 320px; POSITION: absolute; TOP: 64px" runat="server">月</asp:Label>
			<asp:Label id="Label16" style="Z-INDEX: 110; LEFT: 440px; POSITION: absolute; TOP: 72px" runat="server">日</asp:Label>
			<asp:Label id="Label13" style="Z-INDEX: 112; LEFT: 440px; POSITION: absolute; TOP: 96px" runat="server">日</asp:Label>
			<asp:Label id="Label9" style="Z-INDEX: 113; LEFT: 32px; POSITION: absolute; TOP: 96px" runat="server">结束时间：</asp:Label>
			<asp:Label id="Label2" style="Z-INDEX: 102; LEFT: 32px; POSITION: absolute; TOP: 24px" runat="server">类别：</asp:Label>
			<asp:Button id="Button1" style="Z-INDEX: 103; LEFT: 448px; POSITION: absolute; TOP: 24px" runat="server"
				Text="确定"></asp:Button>
			<c1webchart:C1WebChart id="C1WebChart1" style="Z-INDEX: 104; LEFT: 24px; POSITION: absolute; TOP: 128px"
				runat="server" Height="216px" Width="504px" SlidingExpiration="00:10:00" ImageFormat="Png" Visible="False">
...
&lt;/Chart2DPropBag&gt;"></Serializer>
			...
			<asp:Label id="Label1" style="Z-INDEX: 105; LEFT: 32px; POSITION: absolute; TOP: 64px" runat="server">起始时间：</asp:Label>
			<asp:DropDownList id="DropDownList1" style="Z-INDEX: 106; LEFT: 120px; POSITION: absolute; TOP: 56px"
				runat="server"></asp:DropDownList>
			<asp:Label id="Label3" style="Z-INDEX: 108; LEFT: 200px; POSITION: absolute; TOP: 96px" runat="server">年</asp:Label>
			<asp:Label id="Label4" style="Z-INDEX: 111; LEFT: 320px; POSITION: absolute; TOP: 96px" runat="server">月</asp:Label>
			<c1webchart:C1WebChart id="C1WebChart2" style="Z-INDEX: 119; LEFT: 24px; POSITION: absolute; TOP: 368px"
				runat="server" Visible="False" Width="513px" Height="200px">
				<Serializer Value="&lt;?xml version=&quot;1.0&quot;?&gt;
&lt;Chart2DPropBag Version=&quot;&quot;&gt;
  &lt;StyleCollection&gt;
    &lt;NamedStyle Name=&quot;PlotArea&quot; ParentName=&quot;Area&quot;&gt;

<%@ Page language="c#" Codebehind="shouming.aspx.cs" AutoEventWireup="false" Inherits="WebService1.shouming" %>
			...
			<tr>
				<td align="center">
					<form id="Form1" method="post" runat="server">
					  <table width="714" height="210" border="1" cellpadding="0" cellspacing="0" bordercolor="#ccccff"
							background="img/bgyg1.gif">
                        <tr>
                          <td colspan="2"><span class="font2">请选择厂家名称,设备名称和设备编号,则可以预测设备的平均故障时间和设备将要发生故障的时间: </span></td>
                        </tr>
                        <tr>
                          <td width="233" height="31" align="center" class="font3">厂家名称：</td>
                        ...
                        <tr>
                          <td height="34" align="center"><span class="font3"> 设备名称：</span></td>
                          <td>&nbsp;
                              <asp:DropDownList id="DropDownList2" runat="server" AutoPostBack="True"></asp:DropDownList></td>
                        </tr>
                        <tr>
                          <td height="35" align="center" class="font3">设备编号：</td>
                          <td>&nbsp;
                        ...
                        <tr>
                          <td align="center" class="font3">预测设备将发生故障的时间： </td>
                          <td>&nbsp;

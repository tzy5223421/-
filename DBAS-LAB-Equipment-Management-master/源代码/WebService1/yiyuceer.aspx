				...
				<td>
					<form id="Form1" method="post" runat="server">
						<table width="850" height="419" border="1" cellpadding="0" cellspacing="0" bordercolor="#ccccff"
							...
							<tr>
								<td height="33" colspan="2"><span class="font2">请选择厂家名称,设备名称,可以预测已发生故障的设备即将发生下一次故障的时间： </span>
								</td>
							</tr>
							<TR>
								...
								<TD style="HEIGHT: 35px" width="615">
									...
									<asp:RegularExpressionValidator id="RegularExpressionValidator1" runat="server" ErrorMessage="必须是大于0的数字" ControlToValidate="TextBox1"
										ValidationExpression="[1-9]|[1-9][0-9]{1,}"></asp:RegularExpressionValidator></TD>
							</TR>
							<tr>
								<td width="227" height="35" align="center" class="font3">厂家名称：</td>
							...
							<tr>
								<td height="315" align="center" class="font3" style="WIDTH: 207px"><p>预测设备</p>
									<p>下一次发生故障的时间:
									</p>
								</td>
								<td valign="top">
...
&lt;/Chart2DPropBag&gt;"></Serializer>
										...
										<tr>
											<td height="37" align="right">&nbsp;
												<asp:Button id="Button2" runat="server" Text="下一页"></asp:Button></td>
										</tr>
									</table>
								</td>
							</tr>

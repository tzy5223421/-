...
namespace html
{
	...
	public class Admin : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			this.DataGrid1.DataMember="admin";
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			if(db1.getdata().Tables["admin"].Rows[0]["jibie"].ToString().Trim()!="顶级")
				Response.Redirect("cuowu4.htm");
			string sql1="delete from admin where id="+e.Item.Cells[0].Text;
			db1.ExectueSQL("admin",sql1);

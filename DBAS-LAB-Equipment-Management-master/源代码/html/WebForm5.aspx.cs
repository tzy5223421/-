...
namespace html
{
	...
	public class WebForm5 : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string sql1="select * from 维护 order by 实验室名,设备名称";
			db1.cleardata();
			db1.ExectueSQL("维护",sql1);

			this.WebViewer1.ClearCachedReport();
			ActiveReport4 rpt=new ActiveReport4();
			rpt.SetDb(db1);
			//rpt.Restart();
		...
		{    
			...
			WebViewer1.Report = new html.ActiveReport4();
		...
		private void LinkButton1_Click(object sender, System.EventArgs e)
		{
			...
			if(this.Hidden1.Value=="0")
				sql="select * from 维护 order by 实验室,设备名称";
			else
			{
		...
		private void Button2_Click(object sender, System.EventArgs e)
		{
			this.Hidden1.Value="0";
			ActiveReport4 rpt=new ActiveReport4();
			string sql="select * from 维护 order by 实验室名,设备名称";

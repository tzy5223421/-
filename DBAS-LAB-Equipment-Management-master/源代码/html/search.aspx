<%@ Page language="c#" Codebehind="search.aspx.cs" AutoEventWireup="false" Inherits="html.search" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:DropDownList id="DropDownList1" style="Z-INDEX: 101; LEFT: 32px; POSITION: absolute; TOP: 16px"
				runat="server"></asp:DropDownList>
			<asp:DropDownList id="DropDownList2" style="Z-INDEX: 102; LEFT: 32px; POSITION: absolute; TOP: 48px"
				runat="server"></asp:DropDownList>
			<asp:DropDownList id="DropDownList3" style="Z-INDEX: 103; LEFT: 136px; POSITION: absolute; TOP: 48px"
				runat="server"></asp:DropDownList>
			<asp:DropDownList id="DropDownList4" style="Z-INDEX: 104; LEFT: 216px; POSITION: absolute; TOP: 48px"
				runat="server"></asp:DropDownList>
			<asp:DropDownList id="DropDownList5" style="Z-INDEX: 105; LEFT: 40px; POSITION: absolute; TOP: 80px"
				runat="server"></asp:DropDownList>
			<asp:DropDownList id="DropDownList6" style="Z-INDEX: 106; LEFT: 136px; POSITION: absolute; TOP: 80px"
				runat="server"></asp:DropDownList>
			<asp:DropDownList id="DropDownList7" style="Z-INDEX: 107; LEFT: 216px; POSITION: absolute; TOP: 80px"
				runat="server"></asp:DropDownList>
			<asp:Button id="Button1" style="Z-INDEX: 108; LEFT: 472px; POSITION: absolute; TOP: 48px" runat="server"
				Text="Button"></asp:Button>
			<C1WebChart:C1WebChart id="C1WebChart1" style="Z-INDEX: 109; LEFT: 40px; POSITION: absolute; TOP: 128px"
				runat="server" Width="480px" Height="214px" SlidingExpiration="00:10:00" ImageFormat="Png" Visible="False">

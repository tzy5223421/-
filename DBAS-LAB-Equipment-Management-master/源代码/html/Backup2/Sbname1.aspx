<%@ Page language="c#" Codebehind="Sbname1.aspx.cs" AutoEventWireup="false" Inherits="html.Sbname1" %>
			...
			<tr>
				<td>
					<form id="Form1" method="post" runat="server">
						<table width="851" height="233" border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td valign="top" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td align="center"><table width="69%" height="23" border="0" cellpadding="0" cellspacing="0">
													<tr>
														<td width="369" style="WIDTH: 349px"><span> &nbsp;&nbsp;&nbsp;&nbsp;</span></td>
														<td width="214" style="WIDTH: 214px"><asp:Button id="Button1" runat="server" Text="首页" Height="20px"></asp:Button>

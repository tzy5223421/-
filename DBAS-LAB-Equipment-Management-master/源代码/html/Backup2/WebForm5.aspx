<%@ Page language="c#" Codebehind="WebForm5.aspx.cs" AutoEventWireup="false" Inherits="html.WebForm5" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE width="849" height="250" border="0" cellPadding="0" cellSpacing="0">
				<TR>
					<TD vAlign="middle" align="center" background="img/dl_bg.gif" height="30"><FONT size="5" face="隶书">维护信息汇总报表</FONT></TD>
				</TR>
				<TR>
					<TD style="HEIGHT: 177px" vAlign="top" height="177" align="left" class="lishu"><table width="88%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="center">
									<TABLE id="Table1" style="WIDTH: 697px; HEIGHT: 127px" cellSpacing="1" cellPadding="1"
										width="697" border="0">
										<TR>
											<TD style="WIDTH: 640px; HEIGHT: 35px" colSpan="4"><IMG height="18" src="img/dian.jpg" width="18"><SPAN class="font">显示选择实验室名和起止时间，显示该实验室在这段时间里出故障的设备个数，可以另存为Excel文件：</SPAN>
												</SPAN></TD>
										</TR>
										<TR>
										...
										<TR>
											<TD class="lishu" style="WIDTH: 68px"></TD>
								...
								<td align="center"><table width="550" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="297" style="WIDTH: 253px">
												<ActiveReportsWeb:WebViewer id="WebViewer1" runat="server" BorderColor="LightGray" width="677px" height="990px"

<%@ Page language="c#" Codebehind="WebForm1.aspx.cs" AutoEventWireup="false" Inherits="html.WebForm2" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:Label id="Label1" style="Z-INDEX: 101; LEFT: 312px; POSITION: absolute; TOP: 24px" runat="server">Label</asp:Label>
			<asp:DropDownList id="DropDownList1" style="Z-INDEX: 102; LEFT: 64px; POSITION: absolute; TOP: 16px"
				runat="server"></asp:DropDownList>
			<asp:Button id="Button1" style="Z-INDEX: 103; LEFT: 160px; POSITION: absolute; TOP: 16px" runat="server"
				Text="È·¶¨"></asp:Button>
			<C1WebChart:C1WebChart id="C1WebChart1" style="Z-INDEX: 104; LEFT: 48px; POSITION: absolute; TOP: 56px"
				runat="server" Width="496px" Height="208px" Visible="False">

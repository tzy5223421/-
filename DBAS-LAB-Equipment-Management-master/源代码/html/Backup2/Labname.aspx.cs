...
namespace html
{
	...
	/// Labname 的摘要说明。
	/// </summary>
	public class Labname : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			this.DataGrid1.DataMember="labname";
			this.DataGrid1.DataKeyField="实验室id";
			this.DataGrid1.DataBind();
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			string sql1="delete from labname where 实验室id="+e.Item.Cells[0].Text;
			db1.ExectueSQL("labname",sql1);
		...
		{
			string sql1="update labname set 实验室名='"+((TextBox)e.Item.Cells[1].Controls[0]).Text+"'";
			sql1+=" where 实验室id="+e.Item.Cells[0].Text;

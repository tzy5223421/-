				...
				<td>
					<form id="Form1" method="post" runat="server">
						<table width="850" height="397" border="0" cellPadding="0" cellSpacing="0">
							<tr>
								<td width="861" height="26" align="center" vAlign="middle" background="img/dl_bg.gif">&nbsp;<FONT face="隶书" size="5">故障设备管理表</FONT></td>
							</tr>
							<tr>
							...
							<tr>
								<td height="299" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td><span class="font2">注：点击设备id号可以查看每个故障设备的维修情况</span>。</td>
										</tr>
									</table>
								</td>
							</tr>

...
namespace html
{
	...
	public class Errorinfo : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			this.DataGrid1.DataKeyField="故障类型号";
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			string sql1="delete from errorinfo where 故障类型号="+e.Item.Cells[0].Text;
			db1.ExectueSQL("",sql1);
		...
		{
			string sql1="update errorinfo set 故障名称='"+((TextBox)e.Item.Cells[1].Controls[0]).Text+"'";
			sql1+=" where 故障类型号="+e.Item.Cells[0].Text;

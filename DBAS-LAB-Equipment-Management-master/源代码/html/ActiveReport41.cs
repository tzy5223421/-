...
namespace html
{
	public class ActiveReport4 : ActiveReport
	{
		Class1 db1;
		public ActiveReport4()
		{
			db1=new Class1();
			InitializeReport();
		}
		...
		private void ActiveReport4_DataInitialize(object sender, System.EventArgs eArgs)
		{
		...
		{
			this.LoadLayout(this.GetType(), "html.ActiveReport4.rpx");
			...
			this.DataInitialize += new System.EventHandler(this.ActiveReport4_DataInitialize);
		}
